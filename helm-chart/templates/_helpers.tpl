...
{{/*
Name of the component webdynamic.
*/}}
{{- define "webdynamic.name" -}}
{{- printf "%s-webdynamic" (include "enabler.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified component webdynamic name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
If release name contains chart name it will be used as a full name.
*/}}
{{- define "webdynamic.fullname" -}}
{{- printf "%s-webdynamic" (include "enabler.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}


{{/*
Component webdynamic labels.
*/}}
{{- define "webdynamic.labels" -}}
helm.sh/chart: {{ include "enabler.chart" . }}
{{ include "webdynamic.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{/*
Component webdynamic selector labels.
*/}}
{{- define "webdynamic.selectorLabels" -}}
app.kubernetes.io/name: {{ include "enabler.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
enabler: {{ .Chart.Name }}
app.kubernetes.io/component: webdynamic
isMainInterface: "yes"
tier: {{ .Values.webdynamic.tier }}
{{- end }}

...
-- Authz & Keycloak
INSERT INTO pui_variable (variable, value, description) VALUES('SESSION_KEYCLOAK_PUBLIC', '', 'clave pública de Keycloak para validar los tokens JWT');
INSERT INTO pui_variable (variable, value, description) VALUES('KEYCLOAK_TOKEN', 'lnt9vlmdVBTQ4XciVeIGXZHLrbenoUrt', 'Token que usa Keycloak para utilizar los SW de PUI9');
INSERT INTO pui_variable (variable, value, description) VALUES('AUTHZ_IDM_URL_GET_TOKEN', 'http://smart-idm-keycloak:8080/auth/realms/assist-iot/protocol/openid-connect/token', 'Url donde se optiene el token desde Keyclock (idm) para el login con PUI9');
INSERT INTO pui_variable (variable, value, description) VALUES('AUTHZ_IDM_CLIENT_ID', 'assist-iot', 'Clien Id de la app en el real de idm');
INSERT INTO pui_variable (variable, value, description) VALUES('AUTHZ_SERVER_URL_VALIDATE', 'http://smart-authorization-authzweb:8080/authzserver/rest/evaluate', 'Url de validacion authz server');
INSERT INTO pui_variable (variable, value, description) VALUES('AUTHZ_SERVER_SECURITY_DOMAIN', 'pilot3a', 'Security Domain Authz server');
